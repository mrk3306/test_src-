$(function() {
	...
	MapApi.prototype = $.extend({}, GetListUtil.prototype, {
		...
		_get_map: function(event){
			...
			// 位置情報取得に成功したとき
			var position2 = function (position) {
			...
			//初期表示で現在地を表示
			//navigator.geolocation.getCurrentPosition( position2 , error , option)
			map2 = new google.maps.Map(document.getElementById("map"),myOptions2);

			google.maps.event.addListener(map2, 'click', function(mouseEvent) {
